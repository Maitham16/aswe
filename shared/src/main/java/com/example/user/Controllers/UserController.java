...
public class UserController {
    ...
    public String getUsers(Model model, HttpSession session) {
        ...
        model.addAttribute("user", user != null ? user : new User()); // Ensure a non-null user object is always added to the model
    ...
    public String login(@RequestParam String email, @RequestParam String password, Model model, HttpSession session) {
        if (userService.authenticateUser(email, password)) {
            ...
            if (user.getRole().equalsIgnoreCase("organizer")) {
                return "redirect:/users/ui"; // replace with your organizer dashboard URL
            } else {
                return "redirect:/users/ui"; // replace with your attendee dashboard URL
            }
        } else {
